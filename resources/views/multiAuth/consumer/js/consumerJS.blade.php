...
<script>
  //show cardit card payment option
  function showHomeDelivaryOptions(){
    document.getElementById("carditCardIcon").style.color = "#6b6b6b";
    document.getElementById("homeDelivaryIcon").style.color = "#0e94c9";
    document.getElementById("paymentCarditCard").style.display = "none";
    document.getElementById("paymentHomeDelivary").style.display = "block";
  }

  //show home delivary option
  function showCarditCardOptions(){
    document.getElementById("carditCardIcon").style.color = "#0e94c9";
    document.getElementById("homeDelivaryIcon").style.color = "#6b6b6b";
    document.getElementById("paymentHomeDelivary").style.display = "none";
    document.getElementById("paymentCarditCard").style.display = "block";
  }
</script>
