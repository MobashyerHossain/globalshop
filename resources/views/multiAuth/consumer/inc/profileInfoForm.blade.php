    ...
    <div class="form-row">
        ...
        <div class="col" style="padding-left:10px;">
            <div class="form-group">
              ...
              <input class="form-control no-outline rounded-0" type="text" value="{{Auth::user()->getDateOfBirth()}}" readonly="" placeholder="Date of Birth">
              @else
              <input class="form-control no-outline rounded-0" type="text" value="" readonly="" placeholder="Date of Birth">
              @endif
            </div>
        </div>
    </div>
